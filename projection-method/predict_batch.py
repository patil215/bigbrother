...
from classify import classifyDTW, compute_segment, prep_data
...
def do_prediction(training_data, path, sequence_length, statistics, video_class):
	if sequence_length == 1:
		...
		print(video_class)
		print(compute_segment(path, training_data, sequence_length))
...
def predict(test_dir, height, fps, data, angle, length):

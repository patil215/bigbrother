...
frame = frame.copy()[cropRefPt[0][1]:cropRefPt[1][1],
                     cropRefPt[0][0]:cropRefPt[1][0]]
...
src_pts = np.float32([paperRefPt[0], paperRefPt[1],
                      paperRefPt[3], paperRefPt[2]])
dst_pts = np.float32([[0, 0], [850, 0], [0, 1100], [850, 1100]])
...
while True:
    ...
    frame = rawFrame.copy()[cropRefPt[0][1]:cropRefPt[1]
                            [1], cropRefPt[0][0]:cropRefPt[1][0]]
